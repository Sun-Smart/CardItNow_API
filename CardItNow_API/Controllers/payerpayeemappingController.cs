...
namespace CardItNow.Controllers
{
    ...
    [ApiController]
    public class payerpayeemappingController : baseController
    {
        ...
        public payerpayeemappingController(IHttpContextAccessor objhttpContextAccessor, IpayerpayeeprivateService obj_payerpayeeprivateService, ILoggerManager logger) : base(logger)
        {
